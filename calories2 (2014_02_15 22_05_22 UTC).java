...
public class Calories {
    ...
    public static void main(String[] args) {
 		...
 		foodItem = JOptionPane.showInputDialog("What is the food item?");
 		//foodItem = keyboard.nextLine();
 		
 		fatGrams = JOptionPane.showInputDialog("What are the grams of fat of " + foodItem + "?");
 		//fatGrams = keyboard.nextDouble();
 		
 		carbGrams = JOptionPane.showInputDialog("What are the grams of carbs of " + foodItem + "?");
